CMD:goto(playerid, params[])
{
    if(EventKernel[EventCreator] == playerid || PlayerInfo[playerid][pAdmin] >= 2)
	{
		...
		{
			SendClientMessageEx(playerid, COLOR_GREY, "SU DUNG: /goto [dia diem] [(optional) virtual world] [(optional) interior]");
			SendClientMessageEx(playerid, COLOR_GRAD1, "DIA DIEM 1: LS, SF, LV, RC, FC, ElQue, Bayside, Palomino, Flint, Dillimore, Angelpine");
			SendClientMessageEx(playerid, COLOR_GRAD2, "DIA DIEM 2: LSVIP, SFVIP, LVVIP, famed, allsaints, glenpark, lascolinas, sfdocks, demorgan");
			SendClientMessageEx(playerid, COLOR_GRAD2, "DIA DIEM 3: Ganton, rodeo, mall, bank, idlewood, DoC, FBI, Taxi, sfairport, countygen, cracklab");
			SendClientMessageEx(playerid, COLOR_GRAD3, "DIA DIEM 4: icprison,oocprison, island, gnshop, mark, mark2, int1");
			SendClientMessageEx(playerid, COLOR_GRAD4, "DIA DIEM 5: stadium1, stadium2,stadium3,stadium4, garagesm, garagemed, garagelg, garagexlg");
			return 1;
		}
		if(GetPlayerState(playerid) == PLAYER_STATE_SPECTATING)
		{
			SendClientMessageEx(playerid, COLOR_GRAD2, "Ban khong the thuc hien lenh nay khi dang spec.");
			return 1;
		}
		...
		else if(strcmp(location,"gnshop",true) == 0)
		{
			if (GetPlayerState(playerid) == 2)
			{
				new tmpcar = GetPlayerVehicleID(playerid);
		...
		else if(strcmp(location,"angelpine",true) == 0)
		{
			if (GetPlayerState(playerid) == 2)
			{
				new tmpcar = GetPlayerVehicleID(playerid);
		...
		else if(strcmp(location,"ganton",true) == 0)
		{
		 	if (GetPlayerState(playerid) == 2)
			{
				new tmpcar = GetPlayerVehicleID(playerid);
		...
		else if(strcmp(location,"taxi",true) == 0)
		{
			if (GetPlayerState(playerid) == 2)
			{
				new tmpcar = GetPlayerVehicleID(playerid);
		...
		{
			SendClientMessageEx(playerid, COLOR_GREY, "SU DUNG: /goto [dia diem] [(optional) vw] [(optional) interior]");
			SendClientMessageEx(playerid, COLOR_GRAD1, "DIA DIEM 1: LS, SF, LV, RC, FC, ElQue, Bayside, Palomino, Flint, Dillimore, Angelpine");
			SendClientMessageEx(playerid, COLOR_GRAD2, "DIA DIEM 2: LSVIP, SFVIP, LVVIP, famed, allsaints, glenpark, lascolinas, sfdocks, demorgan");
			SendClientMessageEx(playerid, COLOR_GRAD2, "DIA DIEM 3: Ganton, rodeo, mall, bank, idlewood, DoC, FBI, Taxi, sfairport, countygen, cracklab");
			SendClientMessageEx(playerid, COLOR_GRAD3, "DIA DIEM 4: icprison,oocprison, island, gnshop, mark, mark2, int1");
			return SendClientMessageEx(playerid, COLOR_GRAD4, "DIA DIEM 5: stadium1, stadium2,stadium3,stadium4, garagesm, garagemed, garagelg, garagexlg");
		}
		SetPlayerVirtualWorld(playerid, vw);
...
CMD:sendto(playerid, params[])
{
    if(PlayerInfo[playerid][pAdmin] >= 2 || PlayerInfo[playerid][pHelper] >= 2)
	{
		...
		if(sscanf(params, "s[32]u", location, giveplayerid))
		{
			...
			SendClientMessageEx(playerid, COLOR_GRAD3, "Locations 4: glenpark, palomino, nggshop, fc, unity, LC (loscolinas), SFDocks, cauca1, cauca2");
			return 1;
		}
        ...
        if(PlayerInfo[playerid][pHelper] >= 2 && PlayerInfo[giveplayerid][pHelper] >= PlayerInfo[playerid][pHelper])
		{
			SendClientMessageEx(playerid, COLOR_WHITE, "You can't perform this action on an equal or higher level helper.");
			return 1;
		}
		if(PlayerInfo[playerid][pAdmin] >= 2 && PlayerInfo[giveplayerid][pAdmin] >= PlayerInfo[playerid][pAdmin])
		{
		...
		else if(strcmp(location,"cauca1",true) == 0)
		{
			if (GetPlayerState(giveplayerid) == 2)
			{
				new tmpcar = GetPlayerVehicleID(giveplayerid);
				SetVehiclePos(tmpcar, 378.2641, -2046.27, 7.83);
				LinkVehicleToInterior(tmpcar, 0);
				SetVehicleVirtualWorld(tmpcar, 0);
				fVehSpeed[giveplayerid] = 0.0;
			}
			...
			{
				SetPlayerPos(giveplayerid, 378.2641, -2046.27, 7.83);
			}
			format(string, sizeof(string), " You have sent %s to Khu ca ca 1.", GetPlayerNameEx(giveplayerid));
			SendClientMessageEx(playerid, COLOR_WHITE, string);
			SendClientMessageEx(giveplayerid, COLOR_GRAD1, "Ban da duoc dich chuyen!");
			SetPlayerInterior(giveplayerid,0);
			PlayerInfo[giveplayerid][pInt] = 0;
		...
		else if(strcmp(location,"cauca2",true) == 0)
		{
			if (GetPlayerState(giveplayerid) == 2)
			{
				new tmpcar = GetPlayerVehicleID(giveplayerid);
				SetVehiclePos(tmpcar, 836.1507, -2004.10, 12.86);
				LinkVehicleToInterior(tmpcar, 0);
				SetVehicleVirtualWorld(tmpcar, 0);
				fVehSpeed[giveplayerid] = 0.0;
			}
			...
			{
				SetPlayerPos(giveplayerid, 836.1507, -2004.10, 12.86);
			}
			format(string, sizeof(string), " You have sent %s to Khu ca ca 2.", GetPlayerNameEx(giveplayerid));
			SendClientMessageEx(playerid, COLOR_WHITE, string);
			SendClientMessageEx(giveplayerid, COLOR_GRAD1, "Ban da duoc dich chuyen!");
			SetPlayerInterior(giveplayerid,0);
			PlayerInfo[giveplayerid][pInt] = 0;
