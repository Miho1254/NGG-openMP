...
CMD:metaldetector(playerid, params[])
{
	...
	{
		GetPlayerPos(playerid, fPos[0], fPos[1], fPos[2]);
		if(!IsPlayerInRangeOfPoint(playerid, 10.0,  fPos[0], fPos[1], fPos[2])) return SendClientMessageEx(playerid, COLOR_GRAD1, "Ban khong dung tai range of the metal detector.");
