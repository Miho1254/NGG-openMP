...
GetWeekday(display = 0, day = 0, month = 0, year = 0)
{
	...
	if(display == 1)
	{
		...
		{
			case 0: weekday_str = "Thu 7";
			case 1: weekday_str = "CN";
			case 2: weekday_str = "Thu 2";
			case 3: weekday_str = "Thu 3";
			case 4: weekday_str = "Thu 4";
			case 5: weekday_str = "Thu 5";
			case 6: weekday_str = "Thu 6";
		}
	}
	else
	{
