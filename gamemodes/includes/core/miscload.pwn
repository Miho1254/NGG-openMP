...
hook OnGameModeInit() {
  ...
  /*TD_ServerError = TextDrawCreate(321.000000, 428.000000, "SERVER: LENH KHONG TON TAI");
	...
	TD_ServerError = TextDrawCreate(501.500000, 351.777832, "boxum~n~");
	TextDrawLetterSize(TD_ServerError, 0.000000, 1.899998);
	TextDrawTextSize(TD_ServerError, 637.000000, 0.000000);
	TextDrawAlignment(TD_ServerError, 1);
	TextDrawColor(TD_ServerError, -1);
	TextDrawUseBox(TD_ServerError, 1);
	TextDrawBoxColor(TD_ServerError, 255);
	TextDrawSetShadow(TD_ServerError, 0);
	TextDrawSetOutline(TD_ServerError, 0);
	TextDrawBackgroundColor(TD_ServerError, 255);
	TextDrawFont(TD_ServerError, 1);
	TextDrawSetProportional(TD_ServerError, 1);
	TextDrawSetShadow(TD_ServerError, 0);

	TD_ServerError1 = TextDrawCreate(501.000000, 353.022308, "Lenh_Ban_Vua_Nhap_Khong_Ton_Tai");
	TextDrawLetterSize(TD_ServerError1, 0.236000, 1.407110);
	TextDrawAlignment(TD_ServerError1, 1);
	TextDrawColor(TD_ServerError1, -1);
	TextDrawSetShadow(TD_ServerError1, 0);
	TextDrawSetOutline(TD_ServerError1, 0);
	TextDrawBackgroundColor(TD_ServerError1, 255);
	TextDrawFont(TD_ServerError1, 1);
	TextDrawSetProportional(TD_ServerError1, 1);
	TextDrawSetShadow(TD_ServerError1, 0);


	TD_ServerError[0] = TextDrawCreate(520.699462, 361.106781, "Background");
	TextDrawLetterSize(TD_ServerError[0], 0.447998, 1.171911);
	TextDrawTextSize(TD_ServerError[0], 623.199951, 0.000000);
	TextDrawAlignment(TD_ServerError[0], 1);
	TextDrawColor(TD_ServerError[0], 0);
	TextDrawUseBox(TD_ServerError[0], 1);
	TextDrawBoxColor(TD_ServerError[0], 184);
	TextDrawSetShadow(TD_ServerError[0], 0);
	TextDrawSetOutline(TD_ServerError[0], 0);
	TextDrawBackgroundColor(TD_ServerError[0], -16776961);
	TextDrawFont(TD_ServerError[0], 1);
	TextDrawSetProportional(TD_ServerError[0], 1);
	TextDrawSetShadow(TD_ServerError[0], 0);

	TD_ServerError[1] = TextDrawCreate(530.200744, 360.742248, "LENH KHONG TON TAI");
	TextDrawLetterSize(TD_ServerError[1], 0.225998, 1.196799);
	TextDrawAlignment(TD_ServerError[1], 1);
	TextDrawColor(TD_ServerError[1], -1);
	TextDrawSetShadow(TD_ServerError[1], 0);
	TextDrawSetOutline(TD_ServerError[1], 0);
	TextDrawBackgroundColor(TD_ServerError[1], 255);
	TextDrawFont(TD_ServerError[1], 1);
...
*/
	...
	TextDrawSetShadow(TD_ServerError[0], 0);
	TextDrawSetOutline(TD_ServerError[0], 1);
	TextDrawBackgroundColor(TD_ServerError[0], 255);
	TextDrawFont(TD_ServerError[0], 1);
	TextDrawSetProportional(TD_ServerError[0], 1);
	TextDrawSetShadow(TD_ServerError[0], 0);
}
